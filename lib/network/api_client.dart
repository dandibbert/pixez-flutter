...
class ApiClient {
  ...
  Future<Response> getSearchNovel(
    ...
    DateTime? end_date,
    int? bookmark_num,
    int? bookmark_num_min,
    int? bookmark_num_max,
    int? text_length_min,
    int? offset,
    String? lang,
    bool? include_potential_violation_works,
    bool? include_translated_tag_results,
    bool? is_original_only,
    bool? is_replaceable_only,
    bool? merge_plain_keyword_results,
    int? search_ai_type,
    bool force = false,
  }) async {
    final bookmarkMin = bookmark_num_min ?? bookmark_num;
    return httpClient.get(
      "/v1/search/novel",
      queryParameters: notNullMap({
        "filter": "for_android",
        ...
        "start_date": getFormatDate(start_date),
        "end_date": getFormatDate(end_date),
        "bookmark_num": bookmark_num ?? bookmarkMin,
        "bookmark_num_min": bookmarkMin,
        "bookmark_num_max": bookmark_num_max,
        "text_length_min": text_length_min,
        "offset": offset,
        "lang": lang,
        "include_potential_violation_works": include_potential_violation_works,
        "include_translated_tag_results": include_translated_tag_results,
        "is_original_only": is_original_only,
        "is_replaceable_only": is_replaceable_only,
        "merge_plain_keyword_results": merge_plain_keyword_results ?? true,
        "search_ai_type": search_ai_type,
      }),
      options: options
          .copyWith(policy: force ? CachePolicy.refresh : null)
